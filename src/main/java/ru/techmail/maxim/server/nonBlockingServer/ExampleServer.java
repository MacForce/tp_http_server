...
public class ExampleServer implements Runnable {
     ...
     */
    protected ExampleServer(InetSocketAddress address) throws IOException {
     ...
     * RuntimeException, and the server will automatically be {shutDown}
     */
    @Override
    ...
    public static void main(String[] args) throws Exception {
        ExampleServer server = new ExampleServer(new InetSocketAddress(5555));
        while (true) {
            server.run();
            Thread.sleep(100);
        }
